...
export class EditaLibroComponent implements OnInit {
  ...
  public uploader: FileUploader = new FileUploader({ url: environment.apiUrl + 'almacen_archivos/libros/upload', itemAlias: 'pdf' });
  ...
  constructor(
    ...
    private editaLibroService: EditaLibroService
  ) {
